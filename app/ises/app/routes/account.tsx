...
export default function MyAccount() {
    ...
    useEffect(() => {
        ...
        UserService.findById(id).then((res) => {
            setUser(res.data);
        }).catch((err) => {
            console.error(err);
        })
                ...
                <div className="grid grid-cols-2 gap-4 p-10 text-xl">
                    <div className="p-7 bg-slate-50 rounded-lg">
                        ...
                        <div className="grid grid-rows-3 gap-5 p-10">
                            ...
                            <span><span className="font-medium leading-6 text-gray-900">Name: </span>{user.name}</span>
                    ...
                    <div className="p-7 bg-slate-50 rounded-lg">
                        ...
                        <Form className="space-y-6 mt-3 p-8" onSubmit={e => { e.preventDefault(); submitChangePassword(); }}>
                            ...
                            <div>
                                ...
                                <div className="mt-2 font-thin text-sm">You will be signed out after this.</div>
