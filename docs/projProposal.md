...
База знања је сачињена од продукциона правила везаних за безбедност. Правила су писана ручно, од којих су нека динамички направљена употребом шаблона.
Корисници преко интеракције са апликацијом попуњавају радну меморију чињеницама
и догађајима (видети секцију Улази). Систем евалуира правила и на основу њих производи нове чињенице или извршава пословну логику.
